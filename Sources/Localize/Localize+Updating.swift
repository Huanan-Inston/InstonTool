//
//  Localize+Updating.swift
//  CLI
//
//  Created by Huanan on 2026/5/15.
//
...
extension Localize {
    struct Updating: AsyncParsableCommand {
        static let configuration = CommandConfiguration(
            abstract: "Updating iOS project Strings from api or download files ",
            usage: """
            tool localize updating <strings> [--cfg <cfg>] [--keys <key>...] [--keys-file <keys-file>] [--downloaded <downloaded>]
            
            Example:
                tool localize updating ./MapRunner/Strings --keys having_problem_tell_gpt --keys good_job
                tool localize updating ./MapRunner/Strings --keys-file ./keys.txt
                tool localize updating ./MapRunner/Strings --downloaded <dowload path>
            """,
            discussion: """
            Setup Auth before using api.
            """
        )
